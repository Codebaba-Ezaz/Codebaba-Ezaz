...
<style>
  ...
  body{
    ...
    min-height:100vh;
    margin:0;
    background: #0f172a; /* optional background */
    color: #e6eef8;
  ...
  .line{
    ...
    white-space:nowrap;            /* keep on single line for typing */
    border-right: .12em solid rgba(230,238,248,0.9); /* caret */
    display:inline-block;
    box-sizing:content-box;
  }

  /* typing animation using steps() */
  @keyframes typing {
    from { width: 0 }
    to   { width: 100% }
  }
  ...
  /* apply different durations/delays to type lines sequentially */
  .l1 { width: 0; animation: typing 2.4s steps(28,end) 0s forwards, blink .8s step-end infinite 2.4s; font-size:1.6rem; }
  .l2 { width: 0; animation: typing 2.2s steps(22,end) 2.6s forwards, blink .8s step-end infinite 4.8s; font-size:1.4rem; margin-top:8px; display:block; }
  .l3 { width: 0; animation: typing 2.6s steps(30,end) 5.0s forwards, blink .8s step-end infinite 7.6s; font-size:1.2rem; margin-top:6px; display:block; opacity:0.95; }

  /* optional subtle entrance for the whole block after animations */
...
<details>
  ...
  <br/>
  <img src="https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=Codebaba-Ezaz&theme=github_dark" alt="Contribution Graph" />
</details>
  ...
  <tr>
    ...
    <td width="50%">
      ...
      <div align="center">
        ...
        <p><strong>Python, Socket Programming, File Transfer</strong> - A custom FTP server implementation with Python</p>
      </div>
    </td>
  </tr>
</table>
